...
const MyApplications = () => {
  ...
  const handleEdit = (application) => {
    ...
    // Navigate or open modal for edit
  };

  const handleReview = (application) => {
    // Open review modal here
  };

  if (loading) return <div className="text-center py-10 text-lg">Loading applications...</div>;
          ...
          <tbody>
            {applications.map(app => (
              <tr key={app._id} className="hover:bg-indigo-50 transition">
                ...
                <td className="p-3 border">{app.subjectCategory}</td>
                <td className="p-3 border">{app.appliedDegree}</td>
                <td className="p-3 border">${app.applicationFee}</td>
                <td className="p-3 border">${app.serviceCharge}</td>
